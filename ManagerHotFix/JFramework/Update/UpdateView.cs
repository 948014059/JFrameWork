...
namespace Assets.ManagerHotFix.JFramework.Update
{
    class UpdateView : BaseView
    {
        ...
        public void CheckVersionData()
        {
            Action<string> callBack = (_serverData) => {
                ...
                if (updateModel.needHotUpdateList.Count > 0)
                {
                    ...
                    AllowUpdateTf.Find("Text_Title").GetComponent<Text>().text = "检测到新版本";
                    AllowUpdateTf.Find("Text_Info").GetComponent<Text>().text = string.Format("version:{0} \n检测到版本更新,大小：{1}MB \n是否跟新",
        ...
        {
            AllowUpdateTf.Find("Button_Yes").GetComponent<Button>().onClick.AddListener(() => {
                //Debug.Log("开始更新...................");
                StartUpdate();
            });
            AllowUpdateTf.Find("Button_No").GetComponent<Button>().onClick.AddListener(() => {
